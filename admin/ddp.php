...
if (isset($_POST['apia'])) {
	...
	$ur= $_POST['url'];
    $tp= $_POST['tipo'];
	$con="INSERT INTO $pronto( `url`, `nombre`,`tipo`,`api`,`pagina`) VALUES ('$ur','$nm','$tp','$ap','$pa')";
	...
	$ap= $_POST['apie'];
		...
		$i= $_POST['ida'];
        $tp= $_POST['tipo'];
		$cona="UPDATE $pronto SET `url`='$ur',`nombre`='$nm',`tipo`='$tp',`api`='$ap',`pagina`='$pa' WHERE `id`='$i'";
		...
		header("Refresh0");
			...
			$el="DELETE from $pronto where id = '$ie'";
...
<!DOCTYPE html>
			<html lang="en">
					  ...
					  <div id="sidebar"  class="nav-collapse ">
                          ...
                          <li class="mt">
                              ...
                              <form action="ddp.php" method="POST">
								  ...
								  <a href="#" class="active"  onclick="document.forms[2].submit()">
				  ...
				  *********************************************************************************************************************************************************** -->
          		...
          		<div class="col-lg-12">
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Agregar DDP</h4>
			  ...
			  <div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Actualizar DDP</h4>
                      <form class="form-inline" role="form" method="POST">
					  <div class="form-group">
			  ...
			  <div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Eliminar DDP</h4>
                      <form class="form-inline" role="form" method="POST">
					  <div class="form-group">
                              <label class="sr-only" for="exampleInputEmail2">Id</label>
                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
								  ...
								  <th class="hidden-phone"><i class= 'fa fa-film'></i> Api</th>
                              ...
                              <tbody>
								  ...
								  $Seleccionar = mysqli_query($consulta,"SELECT * from $pronto") ;
