...
if (isset($_POST['apia'])) {
	...
	$ur= $_POST['url'];
	$tp= $_POST['tipo'];
	$con="INSERT INTO $estrenos( `url`, `nombre`, `api`, `tipo`, `pagina`) VALUES ('$ur','$nm','$ap','$tp','$pa')";
	...
	header("Refresh0");
		...
		$i= $_POST['ida'];
		$tp= $_POST['tipo'];
		$cona="UPDATE $estrenos SET `url`='$ur',`nombre`='$nm',`api`='$ap',`pagina`='$pa',`tipo`='$tp' WHERE `id`='$i'";
		...
		header("Refresh0");
			...
			$el="DELETE from $estrenos where id = '$ie'";
					  ...
					  <div id="sidebar"  class="nav-collapse ">
						  ...
						  <li class="mt">
							  ...
							  <li class="sub-menu">
                                  ...
                                  <input type="hidden" name="aa" value="fndfnjdnfjdfndjfndjfndfdjfjj">   
                              <a href="#" class="active"  onclick="document.forms[1].submit()" >
		...
		<a href="#"   onclick="document.forms[7].submit()">
			...
			<span>Facturas</span>
				  ...
				  *********************************************************************************************************************************************************** -->
          		...
          		<div class="col-lg-12">
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Agregar estreno</h4>
                      <form class="form-inline" role="form" method="POST">
						  ...
						  <div class="form-group">
                              <label class="sr-only" for="exampleInputEmail2">Tipo</label>
                              <input type="text" class="form-control" name ="tipo" id="exampleInputEmail2" placeholder="Tipo">
                          </div>
						  <div class="form-group">
			  ...
			  <div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Actualizar estreno</h4>
                      <form class="form-inline" role="form" method="POST">
					  <div class="form-group">
			  ...
			  <div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Eliminar estreno</h4>
                      <form class="form-inline" role="form" method="POST">
					  <div class="form-group">
                              <label class="sr-only" for="exampleInputEmail2">Id</label>
                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <th class="hidden-phone"><i ></i> Nombre</th>
								  <th class="hidden-phone"><i ></i> Api</th>
								  <th class="hidden-phone"><i ></i> Tipo</th>
                                  <th><</i> Url de Imagen</th>
							  ...
							  <?php
								  ...
								  $Seleccionar = mysqli_query($consulta,"SELECT * from $estrenos") ;
