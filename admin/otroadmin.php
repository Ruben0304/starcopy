...
if (isset($_POST['usuaria'])) {
	
	$nm= $_POST['usuaria'];
	$sl= $_POST['contraseña'];
	$con="INSERT INTO $loginform(`usuario`,`contraseña`) VALUES ('$nm','$sl')";
	mysqli_query($consulta,$con);
	header("Refresh0");

	}
    
      else  if (isset($_POST['usuariel'])) {
	
			$ie= $_POST['usuariel'];
		
		
			$el="DELETE from $loginform where usuario = '$ie'";
					  ...
					  <div id="sidebar"  class="nav-collapse ">
						  ...
						  <li class="mt">
                              ...
                              <form action="otroadmin.php" method="POST">
								  ...
								  <a href="#"  class="active" onclick="document.forms[5].submit()">
			...
			<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Agregar Admin</h4>
                      <form class="form-inline" role="form" method="POST">
                          <div class="form-group">
                              <label class="sr-only" for="exampleInputEmail2">Usuario</label>
                              <input type="text" class="form-control" name ="usuaria" id="exampleInputEmail2" placeholder="Usuario">
                          </div>
                          <div class="form-group">
                              <label class="sr-only" for="exampleInputEmail2">Contraseña</label>
                              <input type="password" class="form-control" name ="contraseña" id="exampleInputEmail2" placeholder="Contraseña">
                              </div>
			  ...
			  <div class="row mt">
          		<div class="col-lg-12">
					  ...
					  <div class="form-group">
                              <label class="sr-only" for="exampleInputEmail2">Usuario</label>
                              <input type="text" class="form-control" name ="usuariel" id="exampleInputEmail2" placeholder="Usuario">
                          </div>  
