...
<form  method="get" action="busqueda.php">
    ...
    <section id="mainn" >
        ...
        echo '
       <form>
       <input type="Hidden" id="tit" value="'.$titulo.'">
       <input type="Hidden" id="tip" value="'.$tipo.'">
       </form>'
         ?>
         
   <script src="js/apiinfo.js">
      ...
      <table >
	                  	  	  <h4><i class="fa fa-search"></i> Coincidencias en nuestro equipo</h4>
